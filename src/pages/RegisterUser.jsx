    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 px-4 py-10">
      <div className="max-w-md w-full space-y-8 p-10 glass-card">
        <div className="text-center">
          <UserPlus className="h-12 w-12 text-cyan-400 mx-auto" />
        ...
        <form className="mt-8 space-y-4" onSubmit={handleRegister}>
          <div className="relative">
            ...
            <input
              type="number"
              required
              className="appearance-none rounded-lg relative block w-full px-12 py-3 border border-slate-600 bg-slate-700 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-cyan-400"
          ...
          <button
            type="submit"
            className="w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-cyan-500 hover:bg-cyan-400 transition-colors mt-6 shadow-lg shadow-cyan-500/20"
          >
            Create Account
          </button>
        </form>
